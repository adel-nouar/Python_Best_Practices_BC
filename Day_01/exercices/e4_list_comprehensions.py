...
# List comprehension
ingredients_lowercase = [ingredient.lower() for ingredient in ingredients]  # your code
print(ingredients_lowercase)
...
# Dict comprehension
language_lengths = {language: len(language) for language in languages}  # your code
